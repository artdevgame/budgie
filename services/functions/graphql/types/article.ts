import { Article } from "@budgie/core/models/article";
import { Row } from "@budgie/core/lib/database";
import { builder } from "../builder";

const ArticleType = builder.objectRef<Row["article"]>("Article").implement({
  fields: t => ({
...
const CommentType = builder.objectRef<Row["comment"]>("Comment").implement({
  fields: t => ({
